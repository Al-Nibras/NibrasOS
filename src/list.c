...
listnode_t * list_insert_front(list_t * list, const char * val) {
...
void list_insert_back(list_t * list, const char * val) {
	listnode_t * t = kcalloc(sizeof(listnode_t), 1);
	t->prev = list->tail;
    if(list->tail)
        list->tail->next = t;
...
void list_push(list_t * list, const char * val) {
...
void list_enqueue(list_t * list, const char * val) {
...
int list_contain(list_t * list, const char * val) {
    int idx = 0;
